 ...
 return(
  <div className='max-w-[1344px] mx-auto flex flex-col items-center py-20'>
     ...
     {/* <h1 className="text-6xl text-white font-black">
        Seu <span className="font-black text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
          duo</span> está aqui.
     </h1> */}
     ...
     <div className="grid grid-cols-6 gap-6 py-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game0.png" alt='game0' />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradiente absolute bottom-0 left-0 right-0">
              <strong className="font-bold text-white block">League of Legends</strong>
              <span className="text-zinc-300 text-sm">Anúncios</span>
          </div>
        </a>

        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game1.png" alt='game0' />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradiente absolute bottom-0 left-0 right-0">
